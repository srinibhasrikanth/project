...
function PDF() {
  ...
  const handleSubmit = (e) => {
    ...
    doc.text(
      20,
      60,
      ` Subject: Seeking permission to promote public relations activities regarding ${formData.name} in the college.`
    );
    doc.text(
      20,
      70,
    ...
    doc.text(
      20,
      80,
      `proposed to conduct ${formData.name} for ${formData.target}. As a part of this event we request you to grant permission
      `
    );
